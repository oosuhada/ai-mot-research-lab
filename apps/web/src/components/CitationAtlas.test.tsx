      ...
      <LocalePreferenceProvider>
        <CitationAtlas
          ...
          coverage={{
            ...
            full_text_booster_eligible: 0,
            full_text_booster_cooldown: 0,
            full_text_booster_waiting_for_attempts: 0,
            translated_ko: 20,
            translated_ko_title: 20,
            translated_ko_abstract: 12,
            translated_ko_with_full_text: 8,
            translated_ko_without_full_text: 12,
            full_text_without_translated_ko: 34,
