...
TAXONOMY_VERSION = "2026-08-25.v3"
...
RESEARCH_SUBAXES: tuple[ResearchSubaxis, ...] = (
    ...
    # High-volume level-2 territories · level 3
    ResearchSubaxis(
        "governance-trust-calibration",
        "Trust formation and calibration",
        "governance-trust-explainability",
        ("trust in ai", "user trust", "calibrated trust", "trust calibration", "trust"),
        "Formation, calibration, and appropriate reliance in trust toward AI systems.",
    ),
    ResearchSubaxis(
        "governance-xai-explanations",
        "Explainable AI and explanation design",
        "governance-trust-explainability",
        ("explainable ai", "xai", "explainability", "explanation design", "counterfactual explanation"),
        "Explainability approaches and the design of explanations for organizational AI use.",
    ),
    ResearchSubaxis(
        "governance-transparency-disclosure",
        "Transparency and disclosure",
        "governance-trust-explainability",
        ("transparency", "disclosure", "model card", "documentation", "algorithmic transparency"),
        "Transparency, disclosure, and documentation practices around deployed AI.",
    ),
    ResearchSubaxis(
        "governance-interpretability-understanding",
        "Interpretability and human understanding",
        "governance-trust-explainability",
        ("interpretability", "interpretable", "understandability", "comprehensibility", "human understanding"),
        "Interpretability and whether people can meaningfully understand model behavior.",
    ),
    ResearchSubaxis(
        "governance-ai-act-policy",
        "AI regulation and policy frameworks",
        "governance-regulation-compliance",
        ("ai act", "artificial intelligence act", "ai regulation", "ai policy", "regulatory framework"),
        "AI-specific laws, policy frameworks, and regulatory regimes.",
    ),
    ResearchSubaxis(
        "governance-compliance-controls",
        "Compliance controls and management systems",
        "governance-regulation-compliance",
        (
        ...
        "Organizational controls and management systems for regulatory compliance.",
    ),
    ResearchSubaxis(
        "governance-data-privacy",
        "Data governance and privacy",
        "governance-regulation-compliance",
        ("data governance", "privacy", "data protection", "gdpr", "personal data"),
        "Data-governance and privacy obligations intertwined with AI compliance.",
    ),
    ResearchSubaxis(
        "governance-sector-regulation",
        "Sector-specific regulation",
        "governance-regulation-compliance",
        ("health regulation", "financial regulation", "sector regulation", "sector-specific", "regulated industry"),
        "AI regulation and compliance within specific regulated sectors.",
    ),
    ResearchSubaxis(
        "governance-bias-fairness",
        "Bias and fairness",
        "governance-fairness-ethics",
        ("bias", "fairness", "algorithmic fairness", "fair ai", "bias mitigation"),
        "Measurement, mitigation, and organizational consequences of bias and fairness.",
    ),
    ResearchSubaxis(
        "governance-ethical-principles",
        "Ethical principles and frameworks",
        "governance-fairness-ethics",
        ("ethical principle", "ethical framework", "ai ethics", "ethics guideline", "ethical ai"),
        "Normative principles and ethical frameworks for organizational AI.",
    ),
    ResearchSubaxis(
        "governance-social-rights-impact",
        "Social impact and rights",
        "governance-fairness-ethics",
        ("social impact", "human rights", "fundamental rights", "societal impact", "public interest"),
        "Social, societal, and rights-based impacts of AI deployment.",
    ),
    ResearchSubaxis(
        "governance-discrimination-inclusion",
        "Discrimination and inclusion",
        "governance-fairness-ethics",
        ("discrimination", "inclusion", "inequality", "protected group", "disparate impact"),
        "Discrimination, inclusion, and distributional consequences of AI systems.",
    ),
    ResearchSubaxis(
        "org-decision-support",
        "AI decision support",
        "org-decision-making",
        ("decision support", "decision aid", "decision assistance", "decision-support system"),
        "AI systems that support rather than fully replace human organizational decisions.",
    ),
    ResearchSubaxis(
        "org-algorithmic-decisions",
        "Algorithmic and automated decisions",
        "org-decision-making",
        ("algorithmic decision", "automated decision", "automated decision-making", "algorithmic management"),
        "Automated and algorithmic decision processes in organizations.",
    ),
    ResearchSubaxis(
        "org-delegation-autonomy",
        "Decision delegation and autonomy",
        "org-decision-making",
        ("delegation", "decision authority", "decision rights", "autonomy", "delegated decision"),
        "How decision authority and autonomy shift between people and AI.",
    ),
    ResearchSubaxis(
        "org-decision-quality-bias",
        "Decision quality, bias, and performance",
        "org-decision-making",
        ("decision quality", "decision accuracy", "decision bias", "judgment", "judgement"),
        "Quality, accuracy, and bias outcomes in AI-influenced decisions.",
    ),
    ResearchSubaxis(
        "agentic-coordination-orchestration",
        "Coordination and orchestration",
        "agentic-multi-agent-coordination",
        ("coordination", "orchestration", "agent orchestration", "coordinator agent", "orchestrator"),
        "Mechanisms that coordinate and orchestrate multiple agents.",
    ),
    ResearchSubaxis(
        "agentic-communication-protocols",
        "Agent communication and protocols",
        "agentic-multi-agent-coordination",
        ("agent communication", "communication protocol", "message passing", "inter-agent communication", "protocol"),
        "Communication protocols and information exchange among agents.",
    ),
    ResearchSubaxis(
        "agentic-task-allocation-planning",
        "Task allocation and planning",
        "agentic-multi-agent-coordination",
        ("task allocation", "task assignment", "planning", "planner", "task decomposition"),
        "Planning, task decomposition, and allocation across multiple agents.",
    ),
    ResearchSubaxis(
        "agentic-collaboration-negotiation",
        "Collaboration and negotiation",
        "agentic-multi-agent-coordination",
        ("agent collaboration", "negotiation", "cooperation", "collaborative agent", "agent team"),
        "Collaborative, cooperative, and negotiated behavior among agents.",
    ),
    ResearchSubaxis(
        "digital-twin-realtime-monitoring",
        "Real-time monitoring and synchronization",
        "industrial-digital-twin",
        ("real-time monitoring", "real time monitoring", "synchronization", "synchronisation", "sensor data"),
        "Real-time synchronization and monitoring of physical operations through digital twins.",
    ),
    ResearchSubaxis(
        "digital-twin-simulation-virtual",
        "Simulation and virtual experimentation",
        "industrial-digital-twin",
        ("simulation", "virtual experiment", "virtual commissioning", "what-if", "scenario simulation"),
        "Simulation and virtual experimentation using digital-twin representations.",
    ),
    ResearchSubaxis(
        "digital-twin-optimization-control",
        "Optimization and control",
        "industrial-digital-twin",
        ("optimization", "optimisation", "control", "process optimization", "process optimisation"),
        "Optimization and control of industrial processes through digital twins.",
    ),
    ResearchSubaxis(
        "digital-twin-lifecycle-integration",
        "Lifecycle and systems integration",
        "industrial-digital-twin",
        ("lifecycle", "life cycle", "systems integration", "system integration", "plm", "digital thread"),
        "Integration of digital twins across asset lifecycles and enterprise systems.",
    ),
    ResearchSubaxis(
        "maintenance-fault-diagnosis",
        "Fault detection and diagnosis",
        "industrial-predictive-maintenance",
        ("fault detection", "fault diagnosis", "anomaly detection", "failure detection", "diagnostics"),
        "Detection and diagnosis of faults that support predictive maintenance.",
    ),
    ResearchSubaxis(
        "maintenance-prognostics-rul",
        "Prognostics and remaining useful life",
        "industrial-predictive-maintenance",
        ("remaining useful life", "rul", "prognostics", "failure prediction", "time to failure"),
        "Prognostics and remaining-useful-life estimation for industrial assets.",
    ),
    ResearchSubaxis(
        "maintenance-condition-monitoring",
        "Condition monitoring",
        "industrial-predictive-maintenance",
        ("condition monitoring", "condition-based", "condition based", "health monitoring", "asset health"),
        "Condition and asset-health monitoring for maintenance decisions.",
    ),
    ResearchSubaxis(
        "maintenance-planning-scheduling",
        "Maintenance planning and scheduling",
        "industrial-predictive-maintenance",
        ("maintenance planning", "maintenance scheduling", "maintenance optimization", "maintenance optimisation"),
        "Planning and scheduling maintenance actions using predictive information.",
    ),
)
