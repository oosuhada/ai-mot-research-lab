...
AI × MOT Research Lab uses the following permissively licensed libraries in its redesigned research-navigation experience.
...
## Visual-reference-only projects

Graphite, Excalidraw, Onlook, Open Generative UI, genui-canvas, xyflow, Rough.js, Sigma.js, Cytoscape.js, and React Three Fiber were reviewed for interaction principles. No source code from those projects was copied into this repository during this redesign.
